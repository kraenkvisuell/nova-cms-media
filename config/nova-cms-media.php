...
return [
    ...
    's3' => [
        'upload_using_presigned_url' => false,
    ],
    ...
    'types' => [
        'Image' => ['jpg', 'jpeg', 'png', 'gif', 'svg', 'mp4'],
    ...
    'resize' => [
        ...
        'sizes' => [
            'thumb' => [ 200, null, false, false ],
            'medium' => [ 800, null, false, false ],
        ],
    ...
    # Show preview as square
    'square_previews' => false,
];
